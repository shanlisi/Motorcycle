    ...
    render() {
        return (
            <div className='my-tab'>
                ...
                <NavLink to='/list'> <i className='iconfont icon-ft-motorcycle'></i><span>商城</span></NavLink>
                <NavLink to='/shoppingCart'><i className='iconfont icon-gouwuche'></i><span>购物车</span></NavLink>
