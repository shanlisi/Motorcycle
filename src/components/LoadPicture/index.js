...
import './index.less'
import perImg from '../../images/mine-header.jpg'
        ...
        return (
            ...
            <div>
                <div className="con4">
                    ...
                    {
                        this.state.addShow?
                        <span className="addPic"><img src={perImg} /></span>
                            :null
                    }

                    <input ref="upl" className='upload_pic' type='file' id="upload" onClick={()=>this.setState({
                        addShow:false
                    })}/>
